        ...
        <div class="edgtf-top-section-holder-inner">
            ...
            <?php if($show_save_btn) { ?>
                <div class="edgtf-input-change">
                    <i class="fa fa-exclamation-circle"></i><?php esc_html_e('You should save your changes', 'elaine') ?>
                </div>
                <div class="edgtf-changes-saved">
                    <i class="fa fa-check-circle"></i><?php esc_html_e('All your changes are successfully saved', 'elaine') ?>
                </div>
            <?php } ?>
        </div>
    </div>
