<div class="edgtf-tabs-navigation-wrapper">
    <ul class="nav nav-tabs">
        ...
        <?php if (elaine_edge_core_plugin_installed()) { ?>
			<li <?php if($is_backup_options_page) { echo "class='active'"; } ?>><a href="<?php echo esc_url(get_admin_url().'admin.php?page='.EDGE_OPTIONS_SLUG.'_backup_options'); ?>"><i class="fa fa-database edgtf-tooltip edgtf-inline-tooltip left" data-placement="top" data-toggle="tooltip" title="<?php esc_attr_e('Backup Options','elaine'); ?>"></i><span><?php esc_html_e('Backup Options','elaine'); ?></span></a></li>
