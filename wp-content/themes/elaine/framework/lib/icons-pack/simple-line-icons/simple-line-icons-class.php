...
if ( ! function_exists( 'elaine_edge_add_simple_line_icon_pack' ) ) {
	function elaine_edge_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new ElaineEdgeClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'elaine_edge_filter_add_icon_pack_into_collection', 'elaine_edge_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'elaine_edge_add_simple_line_icon_pack_option' ) ) {
	function elaine_edge_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'elaine' );
		
		return $options;
	}
	
	add_filter( 'elaine_edge_filter_add_icon_pack_into_options', 'elaine_edge_add_simple_line_icon_pack_option' );
	add_filter( 'elaine_edge_filter_add_icon_pack_into_social_options', 'elaine_edge_add_simple_line_icon_pack_option' );
}

class ElaineEdgeClassSimpleLineIcons implements iElaineEdgeInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function __construct($title_label = "", $param = "") {
        ...
        $this->styleUrl = EDGE_FRAMEWORK_ICONS_ROOT . '/simple-line-icons/simple-line-icons.css';
    }
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'elaine'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'elaine'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'elaine'),
            'icon-social-facebook'    => esc_html__('Facebook', 'elaine'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'elaine'),
            'icon-social-github'      => esc_html__('Github', 'elaine'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'elaine'),
            'icon-social-instagram'   => esc_html__('Instagram', 'elaine'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'elaine'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'elaine'),
            'icon-social-reddit'      => esc_html__('Reddit', 'elaine'),
            'icon-social-skype'       => esc_html__('Skype', 'elaine'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'elaine'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'elaine'),
            'icon-social-spotify'     => esc_html__('Spotify', 'elaine'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'elaine'),
            'icon-social-twitter'     => esc_html__('Twitter', 'elaine'),
            'icon-social-youtube'     => esc_html__('Youtube', 'elaine')
        );
    }
