...
if ( ! function_exists( 'elaine_edge_add_font_awesome_icon_pack' ) ) {
	function elaine_edge_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new ElaineEdgeClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'elaine_edge_filter_add_icon_pack_into_collection', 'elaine_edge_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'elaine_edge_add_font_awesome_icon_pack_option' ) ) {
	function elaine_edge_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'elaine' );
		
		return $options;
	}
	
	add_filter( 'elaine_edge_filter_add_icon_pack_into_options', 'elaine_edge_add_font_awesome_icon_pack_option' );
	add_filter( 'elaine_edge_filter_add_icon_pack_into_social_options', 'elaine_edge_add_font_awesome_icon_pack_option' );
}

class ElaineEdgeClassIconsFontAwesome implements iElaineEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
