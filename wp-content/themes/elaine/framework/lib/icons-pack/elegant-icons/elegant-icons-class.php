...
if ( ! function_exists( 'elaine_edge_add_font_elegant_icon_pack' ) ) {
	function elaine_edge_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new ElaineEdgeClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'elaine_edge_filter_add_icon_pack_into_collection', 'elaine_edge_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'elaine_edge_add_font_elegant_icon_pack_option' ) ) {
	function elaine_edge_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'elaine' );
		
		return $options;
	}
	
	add_filter( 'elaine_edge_filter_add_icon_pack_into_options', 'elaine_edge_add_font_elegant_icon_pack_option' );
	add_filter( 'elaine_edge_filter_add_icon_pack_into_social_options', 'elaine_edge_add_font_elegant_icon_pack_option' );
}

class ElaineEdgeClassIconsFontElegant implements iElaineEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title_label = "", $param = "") {
		...
		$this->styleUrl = EDGE_FRAMEWORK_ICONS_ROOT . '/elegant-icons/style.min.css';
	}
