...
if ( ! function_exists( 'elaine_edge_add_linear_icon_pack' ) ) {
	function elaine_edge_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new ElaineEdgeClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'elaine_edge_filter_add_icon_pack_into_collection', 'elaine_edge_add_linear_icon_pack' );
}

if ( ! function_exists( 'elaine_edge_add_linear_icon_pack_option' ) ) {
	function elaine_edge_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'elaine' );
		
		return $options;
	}
	
	add_filter( 'elaine_edge_filter_add_icon_pack_into_options', 'elaine_edge_add_linear_icon_pack_option' );
}

class ElaineEdgeClassLinearIcons implements iElaineEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title_label = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = EDGE_FRAMEWORK_ICONS_ROOT . '/linear-icons/style.css';
	}
