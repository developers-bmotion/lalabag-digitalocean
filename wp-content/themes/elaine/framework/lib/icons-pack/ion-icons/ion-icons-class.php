...
if ( ! function_exists( 'elaine_edge_add_ion_icon_pack' ) ) {
	function elaine_edge_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new ElaineEdgeClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'elaine_edge_filter_add_icon_pack_into_collection', 'elaine_edge_add_ion_icon_pack' );
}

if ( ! function_exists( 'elaine_edge_add_ion_icon_pack_option' ) ) {
	function elaine_edge_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'elaine' );
		
		return $options;
	}
	
	add_filter( 'elaine_edge_filter_add_icon_pack_into_options', 'elaine_edge_add_ion_icon_pack_option' );
	add_filter( 'elaine_edge_filter_add_icon_pack_into_social_options', 'elaine_edge_add_ion_icon_pack_option' );
}

class ElaineEdgeClassIonIcons implements iElaineEdgeInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
	...
	function __construct($title_label = "", $param = "") {
		...
		$this->styleUrl = EDGE_FRAMEWORK_ICONS_ROOT . '/ion-icons/css/ionicons.min.css';
	}
