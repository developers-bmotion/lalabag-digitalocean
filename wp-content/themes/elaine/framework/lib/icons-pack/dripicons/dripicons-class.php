...
if ( ! function_exists( 'elaine_edge_add_dripicons_icon_pack' ) ) {
	function elaine_edge_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new ElaineEdgeClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'elaine_edge_filter_add_icon_pack_into_collection', 'elaine_edge_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'elaine_edge_add_dripicons_icon_pack_option' ) ) {
	function elaine_edge_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'elaine' );
		
		return $options;
	}
	
	add_filter( 'elaine_edge_filter_add_icon_pack_into_options', 'elaine_edge_add_dripicons_icon_pack_option' );
}

class ElaineEdgeClassDripicons implements iElaineEdgeInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function __construct($title_label = "", $param = "") {
        ...
        $this->param = $param;
        $this->setIconsArray();
        $this->styleUrl = EDGE_FRAMEWORK_ICONS_ROOT . '/dripicons/dripicons.css';
    }
