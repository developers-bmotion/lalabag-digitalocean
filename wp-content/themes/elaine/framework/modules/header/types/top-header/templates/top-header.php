<?php
if($show_header_top) {
	do_action('elaine_edge_action_before_header_top');
	?>
	...
	<div class="edgtf-top-bar">
		<?php do_action( 'elaine_edge_action_after_header_top_html_open' ); ?>
		...
		<?php do_action( 'elaine_edge_action_before_header_top_html_close' ); ?>
	</div>
	
	<?php do_action('elaine_edge_action_after_header_top');
}