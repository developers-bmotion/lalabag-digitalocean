<?php do_action('elaine_edge_action_before_mobile_navigation'); ?>
...
<nav class="edgtf-mobile-nav">
    <div class="edgtf-grid">
        ...
        wp_nav_menu(array(
            ...
            'link_before' => '<span>',
            'link_after' => '</span>',
            'walker' => new ElaineEdgeClassMobileNavigationWalker()
        )); ?>
    </div>
</nav>
<?php } ?>

<?php do_action('elaine_edge_action_after_mobile_navigation'); ?>