...
if (!class_exists('ElaineEdgeClassFullscreenNavigationWalker')) {
	class ElaineEdgeClassFullscreenNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children) {
					$item_output .= '<span aria-hidden="true" class="edgtf-icon-font-elegant arrow_carrot-down edgtf-icon-element edgtf-fullscreen-menu-arrow" style=""></span>';
				}
				$item_output .= '</a>';
			}
