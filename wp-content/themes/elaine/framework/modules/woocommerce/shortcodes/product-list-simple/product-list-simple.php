...
namespace ElaineCore\CPT\Shortcodes\ProductListSimple;
...
class ProductListSimple implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product List - Simple', 'elaine' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						array(
							...
							'value'      => array(
								esc_html__( 'Sale', 'elaine' )         => 'sale',
								esc_html__( 'Best Sellers', 'elaine' ) => 'best-sellers',
								esc_html__( 'Featured', 'elaine' )     => 'featured'
							),
							'save_always' => true
						),
						array(
							...
							'description' => esc_html__( 'Number of products to show (default value is 4)', 'elaine' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'orderby',
	...
	public function render( $atts, $content = null ) {
		...
		$html = elaine_edge_get_woo_shortcode_module_template_part( 'templates/product-list-template', 'product-list-simple', '', $params );
