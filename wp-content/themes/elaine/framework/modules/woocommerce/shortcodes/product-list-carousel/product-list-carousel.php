...
namespace ElaineCore\CPT\Shortcodes\ProductListCarousel;
...
class ProductListCarousel implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product List - Carousel', 'elaine' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Number Of Visible Items', 'elaine' ),
							'value'       => array(
								esc_html__( 'One', 'elaine' )   => '1',
								esc_html__( 'Two', 'elaine' )   => '2',
								esc_html__( 'Three', 'elaine' ) => '3',
								esc_html__( 'Four', 'elaine' )  => '4',
								esc_html__( 'Five', 'elaine' )  => '5',
								esc_html__( 'Six', 'elaine' )   => '6'
							),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'elaine' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_loop',
							'heading'     => esc_html__( 'Enable Slider Loop', 'elaine' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Autoplay', 'elaine' ),
							'value'       => array_flip( elaine_edge_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'elaine' )
						),
						array(
							...
							'heading'     => esc_html__( 'Slide Duration', 'elaine' ),
							'description' => esc_html__( 'Default value is 5000 (ms)', 'elaine' ),
							'group'       => esc_html__( 'Slider Settings', 'elaine' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'slider_speed_animation',
							'heading'     => esc_html__( 'Slide Animation Duration', 'elaine' ),
							'description' => esc_html__( 'Speed of slide animation in milliseconds. Default value is 600.', 'elaine' ),
							'group'       => esc_html__( 'Slider Settings', 'elaine' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_navigation',
							'heading'     => esc_html__( 'Enable Slider Navigation Arrows', 'elaine' ),
							'value'       => array_flip( elaine_edge_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'elaine' )
						),
						array(
							...
							'heading'    => esc_html__( 'Slider Navigation Skin', 'elaine' ),
							'value'      => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Pagination', 'elaine' ),
							'value'       => array_flip( elaine_edge_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'elaine' )
						),
						array(
							...
							'heading'    => esc_html__( 'Slider Pagination Skin', 'elaine' ),
							'value'      => array(
								esc_html__( 'Default', 'elaine' ) => 'default',
								esc_html__( 'Light', 'elaine' )   => 'light'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Slider Pagination Position', 'elaine' ),
							'value'      => array(
								esc_html__( 'Below Carousel', 'elaine' )  => 'bellow-slider',
								esc_html__( 'Inside Carousel', 'elaine' ) => 'inside-slider'
							),
							'dependency' => array( 'element' => 'slider_pagination', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Slider Settings', 'elaine' )
						),
	...
	public function render( $atts, $content = null ) {
		...
		$html = elaine_edge_get_woo_shortcode_module_template_part( 'templates/product-list', 'product-list-carousel', $params['type'], $params, $additional_params );
