<?php
namespace ElaineCore\CPT\Shortcodes\BlogSlider;
...
class BlogSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog Slider', 'elaine' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							esc_html__( 'Slider', 'elaine' )            => 'slider',
							esc_html__( 'Carousel', 'elaine' )          => 'carousel'
						),
						'save_always' => true
					),
					array(
	...
	public function render( $atts, $content = null ) {
		...
		elaine_edge_get_module_template_part( 'shortcodes/blog-slider/holder', 'blog', '', $params );
