<?php
namespace ElaineCore\CPT\Shortcodes\BlogList;
...
class BlogList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog List', 'elaine' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							...
							esc_html__( 'Simple', 'elaine' ) => 'simple',
							esc_html__( 'Minimal', 'elaine' )  => 'minimal'
						),
						'save_always' => true
					),
					array(
						...
						'heading'    => esc_html__( 'Number of Posts', 'elaine' )
					),
					array(
						'type'       => 'dropdown',
					...
					array(
						'type'        => 'autocomplete',
						'param_name'  => 'category',
						'heading'     => esc_html__( 'Category', 'elaine' ),
						'description' => esc_html__( 'Enter one category slug (leave empty for showing all categories)', 'elaine' )
					),
					array(
						'type'       => 'dropdown',
						'param_name' => 'image_size',
						'heading'    => esc_html__( 'Image Size', 'elaine' ),
						'value'      => array(
							...
							esc_html__( 'Thumbnail', 'elaine' ) => 'thumbnail',
					...
					array(
						...
						'group'      => esc_html__( 'Post Info', 'elaine' )
					),
					array(
						'type'       => 'dropdown',
					...
					array(
						...
						'heading'     => esc_html__( 'Text Length', 'elaine' ),
						'description' => esc_html__( 'Number of words', 'elaine' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Image', 'elaine' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Section', 'elaine' ),
						'value'      => array_flip( elaine_edge_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'type', 'value'   => 'standard' ),
						'group'      => esc_html__( 'Post Info', 'elaine' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Author', 'elaine' ),
						'value'      => array_flip( elaine_edge_get_yes_no_select_array( false, true ) ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Date', 'elaine' ),
						'value'      => array_flip( elaine_edge_get_yes_no_select_array( false, true ) ),
						'group'      => esc_html__( 'Post Info', 'elaine' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Category', 'elaine' ),
						'value'      => array_flip( elaine_edge_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'elaine' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Comments', 'elaine' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Like', 'elaine' ),
						'value'      => array_flip( elaine_edge_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'elaine' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Share', 'elaine' ),
						'value'      => array_flip( elaine_edge_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'elaine' )
					),
					array(
						...
						'heading'    => esc_html__( 'Pagination Type', 'elaine' ),
						'value'      => array(
							esc_html__( 'None', 'elaine' )            => 'no-pagination',
							esc_html__( 'Standard', 'elaine' )        => 'standard-shortcodes',
							esc_html__( 'Load More', 'elaine' )       => 'load-more',
							esc_html__( 'Infinite Scroll', 'elaine' ) => 'infinite-scroll'
						),
						'group'      => esc_html__( 'Additional Features', 'elaine' )
					)
				)
			)
		);
	...
	public function render( $atts, $content = null ) {
		...
		elaine_edge_get_module_template_part( 'shortcodes/blog-list/holder', 'blog', $params['type'], $params );
	...
	public function blogCategoryAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				...
				$data['label'] = ( ( strlen( $value['category_title'] ) > 0 ) ? esc_html__( 'Category', 'elaine' ) . ': ' . $value['category_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $category ) ) {
				...
				if ( ! empty( $category_title ) ) {
					$category_title_display = esc_html__( 'Category', 'elaine' ) . ': ' . $category_title;
				}
