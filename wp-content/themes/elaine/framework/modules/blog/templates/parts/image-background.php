...
$blog_list_image_id = ! empty( $image_meta ) && elaine_edge_blog_item_has_link() ? elaine_edge_get_attachment_id_from_url( $image_meta ) : '';
$background_image   = '';
...
?>
<?php if ( $has_featured ) { ?>
	<div class="edgtf-post-image-background" <?php elaine_edge_inline_style($background_image); ?>>
