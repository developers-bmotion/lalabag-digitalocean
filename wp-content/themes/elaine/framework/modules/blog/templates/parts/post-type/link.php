...
if(elaine_edge_get_blog_module() == 'list') {
...
<div class="edgtf-post-link-holder">
    <div class="edgtf-post-link-holder-inner">
        ...
        <a itemprop="url" href="<?php echo esc_url($post_link); ?>" title="<?php the_title_attribute(); ?>" target="<?php echo esc_attr($post_link_target); ?>">
            <?php } ?>
