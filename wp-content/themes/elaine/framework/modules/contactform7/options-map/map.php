...
if ( ! function_exists('elaine_edge_contact_form_7_options_map') ) {

	function elaine_edge_contact_form_7_options_map() {
		
		elaine_edge_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'elaine' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = elaine_edge_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'elaine' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = elaine_edge_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'elaine' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'elaine' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = elaine_edge_add_admin_row(
			array(
		...
		elaine_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'elaine' ),
			)
		);
		...
		$typography_text_row2 = elaine_edge_add_admin_row(
			array(
		...
		$typography_text_row3 = elaine_edge_add_admin_row(
			array(
		...
		$typography_label_group = elaine_edge_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'elaine' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'elaine' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = elaine_edge_add_admin_row(
			array(
		...
		$typography_label_row2 = elaine_edge_add_admin_row(
			array(
		...
		$background_border_group = elaine_edge_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'elaine' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'elaine' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = elaine_edge_add_admin_row(
			array(
		...
		elaine_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'elaine' )
			)
		);
		...
		elaine_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'elaine' )
			)
		);
		
		$background_border_row2 = elaine_edge_add_admin_row(
			array(
		...
		elaine_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'elaine' ),
			)
		);
		...
		elaine_edge_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'elaine' )
			)
		);
		...
		elaine_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'elaine' )
			)
		);
		
		$background_border_row3 = elaine_edge_add_admin_row(
			array(
		...
		elaine_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Width', 'elaine' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		elaine_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'elaine' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = elaine_edge_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'elaine' ),
				'description' => esc_html__( 'Setup form elements padding', 'elaine' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = elaine_edge_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		elaine_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'elaine' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		elaine_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'elaine' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		elaine_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'elaine' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		elaine_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'elaine' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = elaine_edge_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'elaine' ),
				'description' => esc_html__( 'Setup form elements margin', 'elaine' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = elaine_edge_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		elaine_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top', 'elaine' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		elaine_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom', 'elaine' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		elaine_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'elaine' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'elaine' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = elaine_edge_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'elaine' ),
				'description' => esc_html__( 'Setup button text typography', 'elaine' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = elaine_edge_add_admin_row(
			array(
		...
		$button_typography_row2 = elaine_edge_add_admin_row(
			array(
		...
		$button_background_border_group = elaine_edge_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'elaine' ),
				'description' => esc_html__( 'Setup button background and border style', 'elaine' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = elaine_edge_add_admin_row(
			array(
		...
		elaine_edge_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'elaine' )
			)
		);
		...
		elaine_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'elaine' )
			)
		);
		
		$button_background_border_row2 = elaine_edge_add_admin_row(
			array(
		...
		elaine_edge_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'elaine' )
			)
		);
		...
		elaine_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'elaine' )
			)
		);
		
		$button_background_border_row3 = elaine_edge_add_admin_row(
			array(
		...
		elaine_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'elaine' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		elaine_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'elaine' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = elaine_edge_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'elaine')
		));

		//Text Typography

		$typography_text_group = elaine_edge_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'elaine'),
			'description'	=> esc_html__('Setup typography for form elements text', 'elaine'),
		...
		$typography_text_row1 = elaine_edge_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = elaine_edge_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = elaine_edge_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = elaine_edge_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'elaine'),
			'description'	=> esc_html__('Setup typography for form elements label', 'elaine'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = elaine_edge_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = elaine_edge_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = elaine_edge_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'elaine'),
			'description'	=> esc_html__('Setup form elements background and border style', 'elaine'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = elaine_edge_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = elaine_edge_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = elaine_edge_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = elaine_edge_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'elaine'),
			'description' => esc_html__( 'Setup form elements padding', 'elaine' ),
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = elaine_edge_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = elaine_edge_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'elaine'),
			'description'	=> esc_html__('Setup form elements margin', 'elaine'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = elaine_edge_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = elaine_edge_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'elaine'),
			'description'	=> esc_html__('Setup button text typography', 'elaine'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = elaine_edge_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = elaine_edge_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = elaine_edge_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'elaine'),
			'description'	=> esc_html__('Setup button background and border style', 'elaine'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = elaine_edge_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = elaine_edge_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = elaine_edge_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = elaine_edge_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'elaine')
        ));
        ...
        $typography_label_row3 = elaine_edge_add_admin_row(array(
        ...
        $button_typography_row3 = elaine_edge_add_admin_row(array(
	...
	add_action( 'elaine_edge_action_options_map', 'elaine_edge_contact_form_7_options_map', elaine_edge_set_options_map_position( 'contact_form_7' ) );
}