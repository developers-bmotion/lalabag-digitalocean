 ...
 *
 * Class ElaineEdgeClassWidget
 */
abstract class ElaineEdgeClassWidget extends WP_Widget {
    /**
        ...
        if(is_array($this->params) && count($this->params)) {
            ...
            foreach($this->params as $param) {
                switch($param['type']) {
	                ...
	                case 'colorpicker':
		                ?>
		                <p class="edgtf-widget-color-picker">
			                <label for="<?php echo esc_attr($this->get_field_id($param['name'])); ?>"><?php echo esc_html($param['title']); ?>:</label>
			                <input class="widefat edgtf-color-picker-field" id="<?php echo esc_attr($this->get_field_id($param['name'])); ?>" name="<?php echo esc_attr($this->get_field_name($param['name'])); ?>" type="text" value="<?php echo esc_attr(${$param['name']}); ?>"/>
			                <?php if(!empty($param['description'])) : ?>
				                <span class="edgtf-field-description"><?php echo esc_html($param['description']); ?></span>
			                <?php endif; ?>
		                </p>
            ...
            <p><?php esc_html_e('There are no options for this widget.', 'elaine'); ?></p>
        <?php }
    }
