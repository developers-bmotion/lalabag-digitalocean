	...
	function edgtfInitBlogPagination(){
		...
		var initMainPagFunctionality = function(thisHolder) {
			...
			if(nextPage <= maxNumPages){
				...
				var ajaxData = edgtf.modules.common.setLoadMoreAjaxData(loadMoreDatta, 'elaine_edge_blog_load_more');
...
(function($) {
    ...
    */
	...
	function edgtfProductListAppear() {
        var productListItems = $('.edgtf-pl-holder.edgtf-enable-appear-animation .edgtf-pli');

        if(productListItems.length){
            productListItems.each(function(){
                var thisProductListItem = $(this);

                thisProductListItem.appear(function(){
                    thisProductListItem.addClass('edgtf-appeared');
    ...
    function edgtfInitBlogListShortcodePagination(){
        ...
        var initMainPagFunctionality = function(thisHolder, pagedLink) {
            ...
            if(nextPage <= maxNumPages){
                ...
                var ajaxData = edgtf.modules.common.setLoadMoreAjaxData(loadMoreDatta, 'elaine_edge_blog_shortcode_load_more');
        ...
        if ( edgtf.body.hasClass( 'edgtf-fullscreen-search-with-sidebar' ) ) {
            ...
            if (searchOpener.length > 0) {
	            ...
	            if(searchHolder.length) {
		            edgtf.modules.common.edgtfInitPerfectScrollbar().init(searchHolder);
	            }
                searchOpener.on('click', function (e) {
                    e.preventDefault();
