<?php
namespace ElaineRestaurant\CPT;

use ElaineRestaurant\Lib;

/**
 * Class PostTypesLoader
 * @package ElaineRestaurant\CPT
 */
class PostTypesRegister {
    ...
    private function addPostTypes() {
	    $cpt_class_name = apply_filters('elaine_restaurant_filter_register_custom_post_types', $cpt_class_name = array());
