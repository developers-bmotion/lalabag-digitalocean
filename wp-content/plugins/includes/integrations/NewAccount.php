...
class WMIntegrationNewAccount implements IIntegration
{
  ...
  public function collectData()
  {
    ...
    $this->shortcodes['user_activation_link'] = $this->getActivationURL($this->args['email']->user_email);

    return $this->shortcodes;
  }
  private function getActivationURL($userEmail)
  {
