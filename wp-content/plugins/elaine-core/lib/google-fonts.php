<?php
if ( ! function_exists( 'elaine_edge_init_google_fonts_array' ) ) {
    function elaine_edge_init_google_fonts_array() {
        ...
        $elaine_edge_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'elaine_edge_init_google_fonts_array');
}