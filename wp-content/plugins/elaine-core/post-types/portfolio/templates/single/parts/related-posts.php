...
$show_related_posts = elaine_edge_options()->getOptionValue('portfolio_single_related_posts') == 'yes' ? true : false;

$post_id = get_the_ID();
$related_posts = elaine_core_get_portfolio_single_related_posts($post_id);
?>
