...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Project Info', 'elaine-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Project', 'elaine-core' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
						...
						array(
							...
							'heading'     => esc_html__( 'Project Info Type', 'elaine-core' ),
							'value'       => array(
								esc_html__( 'Title', 'elaine-core' )          => 'title',
								esc_html__( 'Category', 'elaine-core' )       => 'category',
								esc_html__( 'Tag', 'elaine-core' )            => 'tag',
								esc_html__( 'Author', 'elaine-core' )         => 'author',
								esc_html__( 'Date', 'elaine-core' )           => 'date',
								esc_html__( 'Featured Image', 'elaine-core' ) => 'image'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Project Title Tag', 'elaine-core' ),
							'value'       => array_flip( elaine_edge_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'description' => esc_html__( 'Set title tag for project title element', 'elaine-core' ),
							'dependency'  => array( 'element' => 'project_info_type', 'value' => array( 'title' ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'project_info_title',
							'heading'     => esc_html__( 'Project Info Label', 'elaine-core' ),
							'description' => esc_html__( 'Add project info label before project info element/s', 'elaine-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'project_info_title_tag',
							'heading'    => esc_html__( 'Project Info Label Tag', 'elaine-core' ),
							'value'      => array_flip( elaine_edge_get_title_tag( true, array( 'p' => 'p' ) ) ),
