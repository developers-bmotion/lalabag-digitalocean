...
namespace ElaineCore\CPT\Shortcodes\PortfolioCategoryList;
...
class PortfolioCategoryList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map( array(
					'name'     => esc_html__( 'Portfolio Category List', 'elaine-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'value'       => array_flip( elaine_edge_get_number_of_columns_array( true, array( 'one' ) ) ),
						...
						array(
							...
							'heading'     => esc_html__( 'Number of Items Per Page', 'elaine-core' ),
							'description' => esc_html__( 'Set number of items for your portfolio category list. Default value is 6', 'elaine-core' ),
							'value'       => '-1'
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Set image proportions for your portfolio category list', 'elaine-core' )
						),
						array(
							'type'       => 'dropdown',
	...
	public function render( $atts, $content = null ) {
		...
		$html = elaine_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-category-list', 'portfolio-category-holder', '', $params );
