...
class TeamSlider implements Lib\ShortcodeInterface {
    ...
    public function vcMap() {
	    if(function_exists('vc_map')) {
		    vc_map(
		    	array(
				    'name'                      => esc_html__( 'Team Slider', 'elaine-core' ),
				    'base'                      => $this->base,
				    ...
				    'params'                    => array(
					    array(
						    ...
						    'heading'     => esc_html__( 'Number of Columns in Row', 'elaine-core' ),
						    'value'       => array_flip( elaine_edge_get_number_of_columns_array( false ) ),
						    'save_always' => true
					    ),
                        array(
                            'type'        => 'dropdown',
