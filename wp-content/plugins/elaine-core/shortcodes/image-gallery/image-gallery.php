<?php
namespace ElaineCore\CPT\Shortcodes\ImageGallery;
...
class ImageGallery implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image Gallery', 'elaine-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Gallery Type', 'elaine-core' ),
							'value'       => array(
								esc_html__( 'Image Grid', 'elaine-core' ) => 'grid',
								esc_html__( 'Masonry', 'elaine-core' )    => 'masonry',
								esc_html__( 'Slider', 'elaine-core' )     => 'slider',
								esc_html__( 'Carousel', 'elaine-core' )   => 'carousel'
							),
							'save_always' => true,
							'admin_label' => true
						),
						array(
							'type'        => 'attach_images',
							'param_name'  => 'images',
							'heading'     => esc_html__( 'Images', 'elaine-core' ),
							'description' => esc_html__( 'Select images from media library', 'elaine-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'image_size',
							'heading'     => esc_html__( 'Image Size', 'elaine-core' ),
							'description' => esc_html__( 'Enter image size. Example: thumbnail, medium, large, full or other sizes defined by current theme. Alternatively enter image size in pixels: 200x100 (Width x Height). Leave empty to use "full" size', 'elaine-core' )
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Custom Links', 'elaine-core' ),
							'description' => esc_html__( 'Delimit links by comma', 'elaine-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Padding', 'elaine-core' ),
							'description' => esc_html__( 'Padding left and right on stage (can see neighbours).', 'elaine-core' ),
							'value'       => array_flip( elaine_edge_get_yes_no_select_array( false ) ),
							'save_always' => true,
	...
	public function render( $atts, $content = null ) {
		...
		$html = elaine_core_get_shortcode_module_template_part( 'templates/' . $params['type'], 'image-gallery', '', $params );
