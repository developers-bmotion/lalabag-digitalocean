...
<div class="edgtf-video-button-holder <?php echo esc_attr($holder_classes); ?>">
	...
	<?php } else { ?>
		<a class="edgtf-video-button-play" <?php echo elaine_edge_get_inline_style($play_button_styles); ?> href="<?php echo esc_url($video_link); ?>" data-rel="prettyPhoto[video_button_pretty_photo_<?php echo esc_attr($rand); ?>]">
			<span class="edgtf-video-button-play-inner">
	...
	<?php if(!(empty($background_image))){ ?>
        <div class="edgtf-vb-background-image" <?php echo elaine_edge_get_inline_style($background_image_style); ?>></div>
    <?php } ?>
</div>