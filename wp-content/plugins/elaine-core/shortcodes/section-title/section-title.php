<?php
namespace ElaineCore\CPT\Shortcodes\SectionTitle;
...
class SectionTitle implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Section Title', 'elaine-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Two Columns', 'elaine-core' ) => 'two-columns'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Title - Text Position', 'elaine-core' ),
							'value'       => array(
								esc_html__( 'Title Left - Text Right', 'elaine-core' ) => 'title-left',
								esc_html__( 'Title Right - Text Left', 'elaine-core' ) => 'title-right'
							),
							'save_always' => true,
						...
						array(
							...
							'heading'     => esc_html__( 'Space Between Columns', 'elaine-core' ),
							'value'       => array(
								esc_html__( 'Normal', 'elaine-core' ) => 'normal',
								esc_html__( 'Small', 'elaine-core' )  => 'small',
								esc_html__( 'Tiny', 'elaine-core' )   => 'tiny'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'two-columns' ) )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'position',
							'heading'     => esc_html__( 'Horizontal Position', 'elaine-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Holder Side Padding (px or %)', 'elaine-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'title',
						...
						array(
							...
							'group'       => esc_html__( 'Title Style', 'elaine-core' )
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'heading'     => esc_html__( 'Words with Bold Font Weight', 'elaine-core' ),
							'description' => esc_html__( 'Enter the positions of the words you would like to display in a "bold" font weight. Separate the positions with commas (e.g. if you would like the first, second, and third word to have a light font weight, you would enter "1,2,3")', 'elaine-core' ),
							'dependency'  => array( 'element' => 'title', 'not_empty' => true ),
							'group'       => esc_html__( 'Title Style', 'elaine-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Words with Light Font Weight', 'elaine-core' ),
							'description' => esc_html__( 'Enter the positions of the words you would like to display in a "light" font weight. Separate the positions with commas (e.g. if you would like the first, third, and fourth word to have a light font weight, you would enter "1,3,4")', 'elaine-core' ),
							'dependency'  => array( 'element' => 'title', 'not_empty' => true ),
							'group'       => esc_html__( 'Title Style', 'elaine-core' )
						),
						array(
							...
							'description' => esc_html__( 'Enter the position of the word after which you would like to create a line break (e.g. if you would like the line break after the 3rd word, you would enter "3")', 'elaine-core' ),
							'dependency'  => array( 'element' => 'title', 'not_empty' => true ),
							'group'       => esc_html__( 'Title Style', 'elaine-core' )
						),
						array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'text_tag',
							'heading'     => esc_html__( 'Text Tag', 'elaine-core' ),
							'value'       => array_flip( elaine_edge_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'save_always' => true,
							'dependency'  => array( 'element' => 'text', 'not_empty' => true ),
							'group'       => esc_html__( 'Text Style', 'elaine-core' )
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'heading'    => esc_html__( 'Text Font Size (px)', 'elaine-core' ),
							'dependency' => array( 'element' => 'text', 'not_empty' => true ),
							'group'      => esc_html__( 'Text Style', 'elaine-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Text Line Height (px)', 'elaine-core' ),
							'dependency' => array( 'element' => 'text', 'not_empty' => true ),
							'group'      => esc_html__( 'Text Style', 'elaine-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Text Font Weight', 'elaine-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = elaine_core_get_shortcode_module_template_part( 'templates/section-title', 'section-title', '', $params );
	...
	private function getTextStyles( $params ) {
		...
		if ( ! empty( $params['text_font_size'] ) ) {
			$styles[] = 'font-size: ' . elaine_edge_filter_px( $params['text_font_size'] ) . 'px';
		}
		
		if ( ! empty( $params['text_line_height'] ) ) {
			$styles[] = 'line-height: ' . elaine_edge_filter_px( $params['text_line_height'] ) . 'px';
		}
		...
		if ( $params['text_margin'] !== '' ) {
			$styles[] = 'margin-top: ' . elaine_edge_filter_px( $params['text_margin'] ) . 'px';
		}
