<?php
namespace ElaineCore\CPT\Shortcodes\ExpandedGallery;
...
class ExpandedGallery implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Expanded Gallery', 'elaine-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Number of Images', 'elaine-core' ),
							'value'       => array(
								esc_html__( 'Three', 'elaine-core' ) => 'three',
								esc_html__( 'Five', 'elaine-core' )  => 'five'
							),
							'save_always' => true
						),
						array(
							...
							'description' => esc_html__( 'Select images from media library. Images needs to be same size', 'elaine-core' )
						),
						array(
							'type'        => 'textarea',
	...
	public function render( $atts, $content = null ) {
		...
		$html = elaine_core_get_shortcode_module_template_part( 'templates/expanded-gallery', 'expanded-gallery', '', $params );
