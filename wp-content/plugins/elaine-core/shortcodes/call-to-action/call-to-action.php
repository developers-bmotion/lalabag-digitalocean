<?php
namespace ElaineCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Call To Action', 'elaine-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Set Content In Grid', 'elaine-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Elements Proportion', 'elaine-core' ),
							'value'      => array(
								esc_html__( '80/20', 'elaine-core' ) => '80',
								esc_html__( '75/25', 'elaine-core' ) => '75',
								esc_html__( '66/33', 'elaine-core' ) => '66',
								esc_html__( '50/50', 'elaine-core' ) => '50'
							),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'normal' ) )
						),
						array(
							...
							'heading'     => esc_html__( 'Button Text', 'elaine-core' ),
							'value'       => esc_html__( 'Button Text', 'elaine-core' ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'button_top_margin',
							'heading'    => esc_html__( 'Button Top Margin (px)', 'elaine-core' ),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'simple' ) ),
							'group'      => esc_html__( 'Button Style', 'elaine-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'button_type',
							'heading'     => esc_html__( 'Button Type', 'elaine-core' ),
							'value'       => array(
								esc_html__( 'Solid', 'elaine-core' )   => 'solid',
								esc_html__( 'Outline', 'elaine-core' ) => 'outline'
							),
							'save_always' => true,
							'group'       => esc_html__( 'Button Style', 'elaine-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Button Size', 'elaine-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Link', 'elaine-core' ),
							'group'      => esc_html__( 'Button Style', 'elaine-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'button_target',
							'heading'    => esc_html__( 'Button Link Target', 'elaine-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Color', 'elaine-core' ),
							'group'      => esc_html__( 'Button Style', 'elaine-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_color',
							'heading'    => esc_html__( 'Button Hover Color', 'elaine-core' ),
							'group'      => esc_html__( 'Button Style', 'elaine-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_background_color',
							'heading'    => esc_html__( 'Button Background Color', 'elaine-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Hover Background Color', 'elaine-core' ),
							'group'      => esc_html__( 'Button Style', 'elaine-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_border_color',
							'heading'    => esc_html__( 'Button Border Color', 'elaine-core' ),
							'group'      => esc_html__( 'Button Style', 'elaine-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_border_color',
							'heading'    => esc_html__( 'Button Hover Border Color', 'elaine-core' ),
							'group'      => esc_html__( 'Button Style', 'elaine-core' )
						),
						array(
							'type'       => 'textarea_html',
							...
							'value'      => esc_html__( 'I am test text for Call to Action shortcode content', 'elaine-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = elaine_core_get_shortcode_module_template_part( 'templates/call-to-action', 'call-to-action', '', $params );
	...
	private function getButtonHolderStyles( $params ) {
		...
		if ( ! empty( $params['button_top_margin'] ) && $params['layout'] === 'simple' ) {
			$styles[] = 'margin-top: ' . elaine_edge_filter_px( $params['button_top_margin'] ) . 'px';
		}
