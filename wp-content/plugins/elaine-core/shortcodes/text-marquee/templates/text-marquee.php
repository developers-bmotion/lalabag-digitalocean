<div class="edgtf-text-marquee <?php echo esc_attr( $holder_classes ); ?>" <?php echo elaine_edge_inline_style( $text_styles ); ?> <?php echo elaine_edge_get_inline_attrs( $text_data ); ?>>
