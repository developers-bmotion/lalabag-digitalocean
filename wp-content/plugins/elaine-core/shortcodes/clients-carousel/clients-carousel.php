<?php
namespace ElaineCore\CPT\Shortcodes\ClientsCarousel;
...
class ClientsCarousel implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Clients Carousel', 'elaine-core' ),
					'base'            => $this->getBase(),
	...
	public function render( $atts, $content = null ) {
		...
		$html = elaine_core_get_shortcode_module_template_part( 'templates/clients-carousel', 'clients-carousel', '', $params );
