<?php
namespace ElaineCore\CPT\Shortcodes\ClientsCarouselItem;
...
class ClientsCarouselItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Clients Item', 'elaine-core' ),
					'base'                    => $this->getBase(),
					...
					'params'                  => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Hover Image', 'elaine-core' ),
							'description' => esc_html__( 'Select image from media library', 'elaine-core' )
						),
						array(
							'type'        => 'textfield',
	...
	public function render( $atts, $content = null ) {
		...
		$html = elaine_core_get_shortcode_module_template_part( 'templates/clients-carousel-item', 'clients-carousel', '', $params );
