<div class="edgtf-fsis-item">
	<div class="edgtf-fsis-image" <?php elaine_edge_inline_style( $image_styles ); ?>>
		<div class="edgtf-fsis-image-wrapper">
			<div class="edgtf-fsis-image-inner">
				...
				<?php } ?>
				<?php if ( ! empty( $title ) ) { ?>
					<<?php echo esc_attr( $title_tag ); ?> class="edgtf-fsis-title" <?php echo elaine_edge_get_inline_style( $title_styles ); ?>><?php echo wp_kses( $title, array( 'br' => true ) ); ?></<?php echo esc_attr( $title_tag ); ?>>
				<?php } ?>
				<?php if ( ! empty( $subtitle ) ) { ?>
					<<?php echo esc_attr( $subtitle_tag ); ?> class="edgtf-fsis-subtitle" <?php echo elaine_edge_get_inline_style( $subtitle_styles ); ?>><?php echo wp_kses( $subtitle, array( 'br' => true ) ); ?></<?php echo esc_attr( $subtitle_tag ); ?>>
				<?php } ?>
			</div>
		</div>
	</div>
