...
class FullScreenImageSlider implements Lib\ShortcodeInterface {
	...
	public function __construct() {
		$this->base = 'edgtf_full_screen_image_slider';
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Full Screen Image Slider', 'elaine-core' ),
					'base'                      => $this->getBase(),
					'category'                  => esc_html__( 'by ELAINE', 'elaine-core' ),
					'as_parent'                 => array( 'only' => 'edgtf_full_screen_image_slider_item' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = elaine_core_get_shortcode_module_template_part( 'templates/full-screen-image-slider', 'full-screen-image-slider', '', $params );
