<?php
namespace ElaineCore\CPT\Shortcodes\CardsGallery;
...
class CardsGallery implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Cards Gallery', 'elaine-core' ),
					'base'     => $this->base,
					...
					'params'   => array(
						array(
							...
							'value'       => array(
								esc_html__( 'Shuffled right', 'elaine-core' ) => 'shuffled-right',
								esc_html__( 'Shuffled left', 'elaine-core' )  => 'shuffled-left',
							),
							'save_always' => true
						),
						array(
						...
						array(
							...
							'heading'     => esc_html__( 'Bundle Animation', 'elaine-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		return elaine_core_get_shortcode_module_template_part( 'templates/cards-gallery', 'cards-gallery', '', $params );
	}
	...
	private function getGalleryImages( $params ) {
		...
		foreach ( $image_ids as $id ) {
			...
			$image_dimensions = elaine_edge_get_image_dimensions( $image['url'] );
