<a itemprop="url" href="<?php echo esc_url($link); ?>" target="<?php echo esc_attr($target); ?>" <?php elaine_edge_inline_style($button_styles); ?> <?php elaine_edge_class_attribute($button_classes); ?> <?php echo elaine_edge_get_inline_attrs($button_data); ?> <?php echo elaine_edge_get_inline_attrs($button_custom_attrs); ?>>
