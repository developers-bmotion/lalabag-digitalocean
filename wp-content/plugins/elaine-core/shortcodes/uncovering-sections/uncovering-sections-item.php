<?php
namespace ElaineCore\CPT\Shortcodes\UncoveringSections;
...
class UncoveringSectionsItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Uncovering Sections Item', 'elaine-core' ),
					'base'            => $this->base,
					...
					'params'          => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Header Skin', 'elaine-core' ),
							'value'       => array(
								esc_html__( 'Default', 'elaine-core' ) => '',
							...
							'save_always' => true,
							'description' => esc_html__( 'Choose a predefined header style for header elements', 'elaine-core' )
						),
						array(
							'type'        => 'attach_image',
	...
	public function render( $atts, $content = null ) {
		...
		$html = elaine_core_get_shortcode_module_template_part( 'templates/uncovering-sections-item', 'uncovering-sections', '', $params );
