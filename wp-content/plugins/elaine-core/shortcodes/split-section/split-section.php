<?php
namespace ElaineCore\CPT\Shortcodes\SplitSection;
...
class SplitSection implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Split Section', 'elaine-core' ),
					'base'     => $this->base,
					...
					'params'   => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Image Position', 'elaine-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Text Top Margin (px or %)', 'elaine-core' ),
							'dependency' => array( 'element' => 'text', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Text', 'elaine-core' )    => 'simple'
							),
							'save_always' => true,
						...
						array(
							...
							'heading'    => esc_html__( 'Button Top Margin (px or %)', 'elaine-core' ),
							'dependency' => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'      => esc_html__( 'Button Style', 'elaine-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Responsive Breakpoint', 'elaine-core' ),
							'value'       => array(
								esc_html__( 'Never', 'elaine-core' )        => '',
							...
							'description' => esc_html__( 'Choose on which stage you want to break image and text content to be one under other', 'elaine-core' ),
							'save_always' => true
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = elaine_core_get_shortcode_module_template_part( 'templates/split-section', 'split-section', '', $params );
	...
	private function getTextStyles( $params ) {
		...
		if ( $params['text_top_margin'] !== '' ) {
			if ( elaine_edge_string_ends_with( $params['text_top_margin'], '%' ) || elaine_edge_string_ends_with( $params['text_top_margin'], 'px' ) ) {
