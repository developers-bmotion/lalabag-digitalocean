<div class="edgtf-ss-holder <?php echo esc_attr( $holder_classes ); ?>">
	<?php if ( ! empty( $image ) ) { ?>
		<div class="edgtf-ss-image" <?php echo elaine_edge_get_inline_style( $image_styles ); ?>>
			<?php echo wp_get_attachment_image( $image, 'full' ); ?>
		</div>
	<?php } ?>
	<div class="edgtf-ss-content" <?php echo elaine_edge_get_inline_style( $content_style ); ?>>
		<?php if ( ! empty( $title ) ) { ?>
			<<?php echo esc_attr( $title_tag ); ?> class="edgtf-ss-title" <?php echo elaine_edge_get_inline_style( $title_styles ); ?>>
				<?php echo esc_html( $title ); ?>
			</<?php echo esc_attr( $title_tag ); ?>>
		<?php } ?>
		<?php if ( ! empty( $text ) ) { ?>
			<p class="edgtf-ss-text" <?php echo elaine_edge_get_inline_style( $text_styles ); ?>><?php echo wp_kses( $text, array( 'br' => true ) ); ?></p>
		<?php } ?>
		<?php if ( ! empty( $button_text ) ): ?>
			<?php echo elaine_edge_get_button_html( array(
				'custom_class'           => 'edgtf-ss-link',
