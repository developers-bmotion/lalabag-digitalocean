<?php
namespace ElaineCore\CPT\Shortcodes\FullScreenSections;
...
class FullScreenSectionsItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Full Screen Sections Item', 'elaine-core' ),
					'base'            => $this->base,
					...
					'params'          => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Background Image Position', 'elaine-core' ),
							'description' => esc_html__( 'Please insert position in format horizontal vertical position, example - center center', 'elaine-core' ),
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'background_size',
							'heading'     => esc_html__( 'Background Image Size', 'elaine-core' ),
							'value'       => array(
								esc_html__( 'Cover', 'elaine-core' )   => 'cover',
								esc_html__( 'Contain', 'elaine-core' ) => 'contain',
								esc_html__( 'Inherit', 'elaine-core' ) => 'inherit'
							),
							'save_always' => true,
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'padding',
							'heading'     => esc_html__( 'Content Padding', 'elaine-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. You can use px or %', 'elaine-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'vertical_alignment',
							'heading'     => esc_html__( 'Content Vertical Alignment', 'elaine-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Content Horizontal Alignment', 'elaine-core' ),
							'value'       => array(
								esc_html__( 'Default', 'elaine-core' ) => '',
						...
						array(
							...
							'description' => esc_html__( 'Set custom link around item', 'elaine-core' )
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Header and Navigation Skin', 'elaine-core' ),
							'value'       => array(
								esc_html__( 'Default', 'elaine-core' ) => '',
							...
							'save_always' => true,
							'description' => esc_html__( 'Choose a predefined header style for header elements and for full screen sections navigation/pagination', 'elaine-core' )
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_laptop',
							'heading'     => esc_html__('Background Image for Laptops', 'elaine-core'),
							'group'       => esc_html__('Responsiveness', 'elaine-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet',
							'heading'     => esc_html__('Background Image for Tablets - Landscape', 'elaine-core'),
							'group'       => esc_html__('Responsiveness', 'elaine-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet_portrait',
							'heading'     => esc_html__('Background Image for Tablets - Portrait', 'elaine-core'),
							'group'       => esc_html__('Responsiveness', 'elaine-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_mobile',
							'heading'     => esc_html__('Background Image for Mobiles', 'elaine-core'),
							'group'       => esc_html__('Responsiveness', 'elaine-core')
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = elaine_core_get_shortcode_module_template_part( 'templates/full-screen-sections-item', 'full-screen-sections', '', $params );
