...
class FullScreenSections implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Full Screen Sections', 'elaine-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						array(
							...
							'heading'     => esc_html__( 'Enable Continuous Scrolling', 'elaine-core' ),
							'description' => esc_html__( 'Defines whether scrolling down in the last section or should scroll down to the first one and if scrolling up in the first section should scroll up to the last one', 'elaine-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Navigation Arrows', 'elaine-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Pagination Dots', 'elaine-core' ),
							'value'       => array_flip( elaine_edge_get_yes_no_select_array( false, true ) ),
							'save_always' => true
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = elaine_core_get_shortcode_module_template_part( 'templates/full-screen-sections', 'full-screen-sections', '', $params );
