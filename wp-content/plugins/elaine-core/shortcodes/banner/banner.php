<?php
namespace ElaineCore\CPT\Shortcodes\Banner;
...
class Banner implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Banner', 'elaine-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Image Overlay Color', 'elaine-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'hover_behavior',
							'heading'     => esc_html__( 'Hover Behavior', 'elaine-core' ),
							'value'       => array(
								esc_html__( 'Visible on Hover', 'elaine-core' )   => 'edgtf-visible-on-hover',
								esc_html__( 'Visible on Default', 'elaine-core' ) => 'edgtf-visible-on-default',
								esc_html__( 'Disabled', 'elaine-core' )           => 'edgtf-disabled'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Info Position', 'elaine-core' ),
							'value'       => array(
								esc_html__( 'Default', 'elaine-core' )  => 'default',
								esc_html__( 'Top', 'elaine-core' ) => 'top',
								esc_html__( 'Centered', 'elaine-core' ) => 'centered',
						...
						array(
							...
							'heading'     => esc_html__( 'Info Content Padding', 'elaine-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left', 'elaine-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'subtitle',
						...
						array(
							...
							'heading'     => esc_html__( 'Subtitle Tag', 'elaine-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Subtitle Color', 'elaine-core' ),
							'dependency' => array( 'element' => 'subtitle', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Link Text', 'elaine-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'link_color',
							'heading'    => esc_html__( 'Link Text Color', 'elaine-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'link_top_margin',
							'heading'    => esc_html__( 'Link Text Top Margin (px)', 'elaine-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = elaine_core_get_shortcode_module_template_part( 'templates/banner', 'banner', '', $params );
	...
	private function getLinkStyles( $params ) {
		...
		if ( ! empty( $params['link_top_margin'] ) ) {
			$styles[] = 'margin-top: ' . elaine_edge_filter_px( $params['link_top_margin'] ) . 'px';
		}
