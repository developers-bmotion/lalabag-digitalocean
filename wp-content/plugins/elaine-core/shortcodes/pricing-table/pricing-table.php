...
class PricingTable implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Pricing Table', 'elaine-core' ),
					'base'                    => $this->base,
	...
	public function render( $atts, $content = null ) {
		...
		$html = '<div class="edgtf-pricing-tables edgtf-grid-list edgtf-disable-bottom-space clearfix ' . esc_attr( $holder_class ) . '">';
