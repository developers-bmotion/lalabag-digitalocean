<?php
namespace ElaineCore\CPT\Shortcodes\VerticalSplitSliderContentItem;
...
class VerticalSplitSliderContentItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Slide Content Item', 'elaine-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'description' => esc_html__( 'Insert padding in format: Top Right Bottom Left (e.g. 0px 0px 1px 0px)', 'elaine-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'alignment',
							'heading'    => esc_html__( 'Content Alignment', 'elaine-core' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Header/Bullets Style', 'elaine-core' ),
							'value'      => array(
								esc_html__( 'Default', 'elaine-core' ) => '',
	...
	public function render( $atts, $content = null ) {
		...
		$html = elaine_core_get_shortcode_module_template_part( 'templates/vertical-split-slider-content-item-template', 'vertical-split-slider', '', $params );
