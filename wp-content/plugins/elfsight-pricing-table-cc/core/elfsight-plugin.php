...
if (!class_exists('ElfsightPricingTablePlugin')) {
    class ElfsightPricingTablePlugin {
        private $name;
        private $slug;
        private $version;
        private $textDomain;
        ...
        public function __construct($config) {
            ...
            $this->update = new ElfsightPricingTablePluginUpdate($this->updateUrl, $this->version, $this->pluginSlug, $this->purchaseCode);
            $this->widgetsApi = new ElfsightPricingTableWidgetsApi($this->slug, $this->pluginFile, $this->textDomain);
            $this->admin = new ElfsightPricingTablePluginAdmin($config, $this->widgetsApi);
            $this->widget = new ElfsightPricingTableWidget($config, $this->widgetsApi);
            $this->vcElement = new ElfsightPricingTableVCElement($config, $this->widgetsApi);
