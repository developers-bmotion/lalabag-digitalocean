...
/**
 * Class ElaineInstagramHelper
 */
class ElaineInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines elaine_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image, $imageSize ) {
		...
		$imageAtts = apply_filters( 'elaine_instagram_image_atts',
			array(
				'class'  => $imageSize,
