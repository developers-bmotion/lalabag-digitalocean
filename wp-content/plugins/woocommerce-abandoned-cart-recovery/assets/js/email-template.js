    ...
    const getViewBlock = {
        ...
        cartField: function (field) {
            let html = '<div class="wacv-block" data-type="cart" data-field="' + field + '">' + this.handle(field) +
                ...
                `                    <img style="width:140px; vertical-align: middle;" src="${wacv_ls.img_src}product.png">` +
                `                    </td>` +
        ...
        init: function () {
            ...
            el.each(function () {
                ...
                if (data_type === 'cart') {
                    ...
                    content = content.replace(/\b(?:https?:\/\/)?[^\/:]+\/.*?product.png/i, '{wacv_image_product}');
                }
    ...
    const controlPanel = {
        ...
        editor: function (target) {
            tinymce.init({
                ...
                toolbar: ['bold italic underline | alignleft aligncenter alignright | link ', 'fontsizeselect | forecolor | shortcode ', 'fontselect'],
