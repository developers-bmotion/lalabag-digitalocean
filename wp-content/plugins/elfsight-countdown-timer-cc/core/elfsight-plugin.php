...
if (!class_exists('ElfsightCountdownTimerPlugin')) {
    class ElfsightCountdownTimerPlugin {
        private $name;
        private $slug;
        private $version;
        private $textDomain;
        ...
        public function __construct($config) {
            ...
            $this->update = new ElfsightCountdownTimerPluginUpdate($this->updateUrl, $this->version, $this->pluginSlug, $this->purchaseCode);
            $this->widgetsApi = new ElfsightCountdownTimerWidgetsApi($this->slug, $this->pluginFile, $this->textDomain);
            $this->admin = new ElfsightCountdownTimerPluginAdmin($config, $this->widgetsApi);
            $this->widget = new ElfsightCountdownTimerWidget($config, $this->widgetsApi);
            $this->vcElement = new ElfsightCountdownTimerVCElement($config, $this->widgetsApi);
